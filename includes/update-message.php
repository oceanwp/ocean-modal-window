...
if ( ! class_exists( 'OMW_Plugin_Update_Message' ) ) :

	class OMW_Plugin_Update_Message {
			...
			<div class="owp-update-warning">
				...
				<div>
					<div class="warning__title">
						<?php echo esc_html__( 'Backup recommended before plugin update.', 'ocean-modal-window' ); ?>
					</div>
					<div class="warning__message">
						<?php
						printf(
							/* translators: %1$s Link open tag, %2$s: Link close tag. */
							esc_html__( 'The latest update introduces significant improvements and changes to various plugin features.  For a smooth update process, it\'s crucial to %1$s backup your website beforehand  %2$s and test the update in a staging or test environment if available.', 'ocean-modal-window' ),
				...
				<div>
					...
					<div class="owp-required-products">
						<table class="owp-required-version-table">
							<tbody>
								<tr>
									<th><?php echo esc_html__( 'Items', 'ocean-modal-window' ); ?></th>
									<th><?php echo esc_html__( 'Required Version', 'ocean-modal-window' ); ?></th>
								</tr>
								<tr>
									<td><?php echo esc_html__( 'OceanWP', 'ocean-modal-window' ); ?></td>
									<td><?php echo esc_html__( '4.0.0', 'ocean-modal-window' ); ?></td>
								</tr>
								<tr>
									<td><?php echo esc_html__( 'Ocean Extra', 'ocean-modal-window' ); ?></td>
									<td><?php echo esc_html__( '2.4.0', 'ocean-modal-window' ); ?></td>
								</tr>
							</tbody>
						</table>
					</div>
